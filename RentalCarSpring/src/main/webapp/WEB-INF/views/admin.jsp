...
<nav class="navbar navbar-expand-lg navbar-light bg-light" >
 ...
 <c:choose>
	<c:when test="${prenotazioni.size()>0}">
		<h1 class="display-3">CI SONO ${prenotazioni.size()} NUOVA/E PRENOTAZIONI</h1>
	</c:when>
	<c:otherwise>
		<h1 class="display-3">NON CI SONO NUOVE PRENOTAZIONI</h1>
	</c:otherwise>
 </c:choose>
